...
public class AnsprechpartnerFactory {
	...
	public static Ansprechpartner aCompleteAnsprechpartner() {
		return aCompleteAnsprechpartnerBuilder().build();
	}
	
	public static AnsprechpartnerBuilder aCompleteAnsprechpartnerBuilder() {
		return AnsprechpartnerBuilder.aAnsprechpartner().withId(ID).withStandortId(STANDORT_ID).withTelefonnummer(TELEFONNUMMER)
	...
	public static AnsprechpartnerBuilder aMinimalAnsprechpartnerBuilder() {
		return AnsprechpartnerBuilder.aAnsprechpartner().withStandortId(STANDORT_ID).withPersonId(PERSON_ID);
	}
